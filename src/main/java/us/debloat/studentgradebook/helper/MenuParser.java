...
//			.addHeaderBorder(BorderStyle.fancy_heavy)
	...
	public static String fourParameter(int index, String title, String rating, Integer count) {
		...
		result.append("|").append(" ".repeat(index < 10 ? 1 : 0)) //no more than 99 movies
		...
		result.append(" ").append(rating).append(" ".repeat(count > 9 ? 5 : 6)).append(count).append(" ".repeat(5)).append('|');
